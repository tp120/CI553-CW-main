...
public class CashierModel extends Observable
{
  ...
  public void doReserve()
  {
    ...
    try {
      if (theState != State.checked) {
        theAction = "Confirm with customer first";
      } else {
        boolean stockreserved = theStock.reserveStock{
        ...
        if (stockreserved) {
          ...
          theAction = "Reserved for you" + theProduct.getDescription();
        } else {
          theAction = "!!! Cant be reserved";
        }
      }
    } catch (StockException e)
      {
      DEBUG.error("%s\n%s", "CashierModel.doReserve", e.getMessage());
      theAction = e.getMessage();
    }
  ...
  public void doBought()
  {
    ...
    try
    {
      ...
      double orderTotal = theBasket.getTotalCost() - theBasket.getDiscount();
      theOrder.newOrder(theBasket);            // Processing order
      theAction = "Next customer - Total cost: " + orderTotal;            // New Customer
      theState = State.process;               // All Done
